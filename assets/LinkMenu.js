...
item_list = [{
    ...
    item: [{
        "url": "/api/downloader/instagram?url=https://www.instagram.com/p/CMeFrnTp8as",
...
},
{
    ...
    item: [
        ...
        // {
        {
            url: '/api/others/font?teks=Gilang Developer',
            name: 'Font',
        },
        {
            url: '/api/others/font2?teks=Gilang Developer',
            name: 'Font2',
        },
        {
            url: '/api/others/iplookup?ip=8.8.8.8',
            name: 'IP Lookup',
        },
        {
            url: '/api/others/cuaca',
            name: 'Cuaca',
        },
        {
            url: '/api/others/tinyurl',
            name: 'Tinyurl',
        },
        {
            event: 'New',
            url: '/api/others/ppcouple',
            name: 'PP Couple',
        },
        {
            event: 'DARK',
